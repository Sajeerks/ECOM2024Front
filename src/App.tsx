...
const  {loading, user} = useSelector((state:RootState)=>state.userReducer)

// return signOut(auth).then((s)=>console.log("doneeeeeeee"))
  useEffect(() => {
